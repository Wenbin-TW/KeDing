...
圖表展示了導入貪婪收養機制與雙重限制後，各營業所車隊的配送路徑。透過 Folium 結合 OSRM API 進行真實路徑的渲染。

*(點擊下方圖片即可進入全螢幕互動式地圖預覽)*

[![AI智慧派車路徑預覽](map.png)](https://wenbin-tw.github.io/KeDing/AI%E6%99%BA%E6%85%A7%E6%B4%BE%E8%BD%A6/dispatch_map_final.html)

> 註：圖表證明了導入硬規則後處理在物流領域的必要性，各營業所車隊的平均滿載率顯著上升，且單車低於三站的無效派遣比例大幅下降。
